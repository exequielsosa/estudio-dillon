    ...
    <div className="h-56 sm:h-64 xl:h-80 2xl:h-96">
      <Carousel slideInterval={5000}>
        <Link href="/impuestos">
          ...
          <span className="absolute top-1/2 left-1/2 text-2xl font-bold text-fuchsia-600 -translate-x-1/2 -translate-y-1/2 sm:text-3xl dark:text-gray-800 bg-indigo-200 opacity-75 font-['Titillium_Web'] tracking-wider">
