              ...
              <section className="articles">
                ...
                <article>
                  ...
                  <p className="mb-4">
                    ...
                    sociedades y trámites societarios. El detalle de la Oferta
                  ...
                  <ul className="list-disc ml-8 mb-6">
                    ...
                    <li>
                      Trámites Sociedades y Sucursales del Exterior: inscripción
                      y servicios generales de bookkeeping.
                    </li>
                    <li>
                ...
                <article>
                  ...
                  <p className="mb-4">
                    ...
                    diversas instituciones o particulares a efectos de constatar
                    determinada situación económica, financiera, patrimonial,
                    fiscal, etc.. Dichos Certificados son confeccionados por
                    Profesional Contable y legalizados por el Consejo
                    Profesional de Ciencias Económicas de la Ciudad Autónoma de
                    Buenos Aires (CABA).
                  </p>
                  <p className="mb-2 font-semibold opacity-70">
                    Algunos tipos de certificados solicitados en forma corriente
                    son:
                  </p>
                  <ul className="list-disc ml-8 mb-6">
